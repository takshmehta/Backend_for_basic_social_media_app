In this project I have created backend for a basic social media website. The website has registration, login, profile, questions, etc routes. User needs to register first and then 
